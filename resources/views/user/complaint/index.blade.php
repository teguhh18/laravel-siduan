            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="d-flex gap-2 mb-3">
                        <a href="{{ route('user.complaint.create') }}" class="btn btn-primary">Tambah</a>
                    </div>
                            ...
                            @foreach ($complaints as $complaint)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('user.complaint.show', $complaint->id) }}"
                                            class="btn btn-info btn-sm">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="javascript:;"
                                            data-url="{{ route('user.complaint.modal-delete', $complaint->id) }}"
